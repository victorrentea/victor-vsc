...
| `update-patch.js` | butonul „Update with AI" din stânga celui albastru de update: armează un marker, iar după repornire reaplică singur `vscode-patch/apply.sh` (și cheamă Claude dacă o ancoră s-a rupt) — vezi `VSCODE-UPDATE.md` |
