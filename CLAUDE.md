...
| `presentation.js` | „Vic Presentation" (⌘F12, View › Vic Presentation): ascunde taburi, activity bar, status bar, title bar (prin full screen), glyph margin și folding; scrie setările globale și le pune înapoi pe cele vechi la ieșire. Intrarea din meniul View o adaugă `vscode-patch/apply.sh` (pasul 3g) — extensiile n-au acces la meniul View |
